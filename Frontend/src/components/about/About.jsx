  ...
  return (
    <div className="about-container">
      ...
      <div id="about" className="about-app">
        ...
        <p className="about-app-p"><strong>Identify overspending:</strong> Take control of your finances by identifying and reducing overspending with an expense tracker.</p>
        <p className="about-app-p"><strong>Real-time visibility:</strong> Monitor your expenses in real-time, whether you are at home or on-the-go, with a user-friendly interface.</p>
        <p className="about-app-p"><strong>Expense Reports:</strong> Centralize, control and track all expenses.</p>
        <p className="about-app-p"><strong>Visual Reports:</strong> Utilize visual graphs and charts generated by the app to quickly grasp spending patterns, making it easier to identify areas for improvement in your financial management.</p>
        <p className="about-app-p"><strong>Goal Tracking:</strong> Whether you're saving for a vacation, a new gadget, or an emergency fund, the expense tracker can help you monitor progress towards your financial goals.</p>
      </div>
    </div>
  );
}
